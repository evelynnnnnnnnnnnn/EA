...
$result = [
	...
	'facebook-messenger' => [
		...
		'html' => '<li class="landing-block-card-social list-inline-item g-mr-10 g-mb-10" data-card-preset="facebook-messenger">
							<a class="landing-block-card-social-link u-icon-v3 u-icon-size--xs g-width-35 g-height-35 g-color-primary g-color-white--hover g-bg-white g-bg-gray-dark-v2--hover g-transition-0_2 g-transition--ease-in" href=""><i class="landing-block-card-social-icon fab fa-facebook-messenger"></i></a>
						</li>',
		'disallow' => ['.landing-block-card-social-icon'],
		'values' => [
			'.landing-block-card-social-link' => [
