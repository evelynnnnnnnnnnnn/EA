...
class StoreCatalogDetailBlockStoreV3 extends \Bitrix\Landing\LandingBlock
{
	...
	public function beforeView(\Bitrix\Landing\Block $block)
	{
		...
		$this->params['GLOBAL_PRODUCT_STORAGE_NAME'] = 'CURRENT_PRODUCT_ID';
	...
	/**
	 * Saves current element id to storage for carousel filtering.
	 *
	 * @param int $elementId
	 * @return void
	 */
	public function setCurrentElement(int $elementId): void
	{
		if ($elementId > 0)
		{
			$GLOBALS[$this->get('GLOBAL_PRODUCT_STORAGE_NAME')] = $elementId;
		}
	}
