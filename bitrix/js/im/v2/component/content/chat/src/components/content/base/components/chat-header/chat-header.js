...
import {ChatActionType, ChatType, EventType, SidebarDetailBlock} from 'im.v2.const';
...
export const ChatHeader = {
	name: 'ChatHeader',
	components: { Avatar, AddToChat, CallButton, GroupChatTitle, UserTitle, LineLoader, FadeAnimation },
	props:
	{
		dialogId: {
			type: String,
