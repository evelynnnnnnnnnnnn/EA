	  ...
	  getCopyFileItem() {
	    ...
	    return {
	      ...
	      onclick: () => {
	        ...
	        if ((_BX$clipboard3 = BX.clipboard) != null && _BX$clipboard3.copy(textToCopy)) {
	          BX.UI.Notification.Center.notify({
