...
(function (exports,im_v2_lib_dateFormatter,ui_vue3,ui_lottie,im_v2_lib_user,im_v2_lib_logger,ui_reactionsSelect,ui_vue3_components_reactions,im_v2_lib_utils,im_v2_application_core,im_v2_lib_menu,im_v2_provider_service,im_v2_lib_parser,main_core,main_core_events,im_v2_const,im_v2_component_elements,im_v2_lib_permission,im_v2_component_animation) {
	'use strict';
	...
	const ReactionSelector = {
	  ...
	  computed: {
	    ...
	    canSetReactions() {
	      return main_core.Type.isNumber(this.messageId) && this.canSetReactionsByRole && !this.isBot && !this.hasError && this.areReactionsEnabledForType;
	    },
...
}((this.BX.Messenger.v2.Component.Message = this.BX.Messenger.v2.Component.Message || {}),BX.Messenger.v2.Lib,BX.Vue3,BX.UI,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Ui,BX.Vue3.Components,BX.Messenger.v2.Lib,BX.Messenger.v2.Application,BX.Messenger.v2.Lib,BX.Messenger.v2.Provider.Service,BX.Messenger.v2.Lib,BX,BX.Event,BX.Messenger.v2.Const,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Lib,BX.Messenger.v2.Component.Animation));
