...
(function (exports,im_v2_lib_layout,im_v2_lib_textarea,im_v2_component_sidebar,im_v2_component_entitySelector,im_v2_lib_localStorage,im_v2_lib_menu,im_public,im_v2_lib_call,im_v2_component_animation,im_v2_lib_utils,ui_uploader_core,im_v2_lib_theme,main_core,ui_notification,main_core_events,im_v2_lib_permission,im_v2_application_core,im_v2_lib_rest,im_v2_lib_logger,im_v2_model,im_v2_component_dialog_chat,im_v2_const,im_v2_component_messageList,im_v2_component_textarea,im_v2_component_elements,im_v2_provider_service) {
	'use strict';
	...
	const DropArea = {
	  ...
	  methods: {
	    ...
	    async onDrop(event) {
	      event.preventDefault();
	      const files = await ui_uploader_core.getFilesFromDataTransfer(event.dataTransfer);
	...
	const ChannelDialog = {
	  ...
	  watch: {
	    realCommentsWithCounter(newList, oldList) {
	  ...
	  created() {
	    this.localCommentsCounterMap = {
	      ...this.realCommentsCounterMap
	    };
	  },
	  methods: {
	    ...
	    getAddedElements(newList, oldList) {
	      return newList.filter(chatId => {
	        return !oldList.includes(chatId);
	      });
	    },
	    getRemovedElements(newList, oldList) {
	...
	const CommentsService = {
	  subscribe(dialogId) {
	    im_v2_application_core.Core.getStore().dispatch('chats/unmute', {
	      dialogId
	    });
	  ...
	  unsubscribe(dialogId) {
	    im_v2_application_core.Core.getStore().dispatch('chats/mute', {
	      dialogId
	    });
	...
	const CommentsHeader = {
	  ...
	  computed: {
	    ...
	    showFollowToggle() {
	      return im_v2_lib_permission.PermissionManager.getInstance().canPerformAction(im_v2_const.ChatActionType.followComments, this.dialogId);
	    }
	  },
	  methods: {
	    onBackClick() {
	...
	class CommentsMessageMenu extends im_v2_component_messageList.MessageMenu {
	  ...
	  isPostMessage() {
	    ...
	    return [im_v2_const.ChatType.openChannel, im_v2_const.ChatType.channel].includes(type);
	  }
	}
...
}((this.BX.Messenger.v2.Component.Content = this.BX.Messenger.v2.Component.Content || {}),BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Component,BX.Messenger.v2.Component.EntitySelector,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Component.Animation,BX.Messenger.v2.Lib,BX.UI.Uploader,BX.Messenger.v2.Lib,BX,BX,BX.Event,BX.Messenger.v2.Lib,BX.Messenger.v2.Application,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Model,BX.Messenger.v2.Component.Dialog,BX.Messenger.v2.Const,BX.Messenger.v2.Component,BX.Messenger.v2.Component,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Provider.Service));
