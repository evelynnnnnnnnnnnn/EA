...
$MESS["WEBPROSTOR_SMTP_LOGS_ARE_TOO_BIG"] = "webprostor.smtp: Превышен лимит записей в журнале отправки. Очистите журнал вручную или активируйте автоматическое очищение в настройках модуля. <a href=\"/bitrix/admin/webprostor.smtp_logs.php?lang=".LANGUAGE_ID."\">Проверить журнал отправки</a>";
$MESS["WEBPROSTOR_SMTP_ERROR_LIMIT_EXCEEDED"] = "webprostor.smtp: Превышен лимит не отправленных сообщений. <a href=\"/bitrix/admin/webprostor.smtp_logs.php?lang=".LANGUAGE_ID."&apply_filter=Y&find_sended=N&SENDED=N\">Проверить журнал отправки</a>";
?>